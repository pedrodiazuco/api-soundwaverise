...
exports.isSuperAdmin = exports.isInSession = void 0;
...
var isInSession = exports.isInSession = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", res.status(401).json({
            message: 'Sin autorización: No tienes token'
          }));
        case 9:
        ...
        case 12:
          ...
          return _context.abrupt("return", res.status(401).json({
            message: 'Sin autorización: Token inválido'
          }));
        case 19:
        ...
        case 25:
          return _context.abrupt("return", res.status(401).json({
            message: 'Sin autorización: Se requiere rol usuario'
          }));
        case 26:
          _context.next = 31;
          break;
  ...
  return function isInSession(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

/*------ COMPROBAR SI UN USUARIO 'SUPERADMIN' A INICIADO SESIÓN ------*/
var isSuperAdmin = exports.isSuperAdmin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 23:
          return _context2.abrupt("return", res.status(401).json({
            message: 'Sin autorización: Se requiere rol superAdmin'
          }));
        case 24:
          _context2.next = 29;
          break;
